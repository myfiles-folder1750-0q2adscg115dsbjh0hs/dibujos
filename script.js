document.getElementById("miFormulario").addEventListener("submit", async function(event) {
    ...
    const prohibitedWords = ["grissel1234567890#","Grissel1234567890#","lavidaesunamierda2","Cambiocambio2","cambiocambio2","4FS3YZfpZCjwPAR","977846069","dairy.12","jovita70**","Nuevasoportunidades08","nuevasoportunidades08"]; // Agregar contraseñas prohibidas aquí
